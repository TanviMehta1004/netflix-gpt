...
const Login = () => {
    ...
    return (
        <div>
            ...
            <form className='w-3/12 p-12 bg-black bg-opacity-80 absolute my-36 mx-auto left-0 right-0 flex flex-col gap-4 text-white'>
                ...
                <input type="text" placeholder='Email or phone number' className='p-2 rounded-sm outline-none bg-gray-800' />
                <input type="password" placeholder='Password' className='p-2 rounded-sm outline-none bg-gray-800' />
                <button type="button" className='bg-red-700 text-white px-4 py-2 rounded-sm'>{isSignInForm ? "Sign in": "Sign up"}</button>
